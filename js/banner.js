function Banner() {
    ...
    var reload = function(canvas_id) {
        ...
        canvasW = canvas.parentNode.offsetWidth;
    ...
    var prepare = function() {
        ...
        bgContext.font = "200px 'Lobster'";

        //Fill the keyword text onto the canvas.
        bgContext.fillText(keyword, (canvasW / 2) - (Math.round(bgContext.measureText(keyword).width / 2)), 210);
...
if (Modernizr.canvas) {
    ...
    google.setOnLoadCallback(function() {
        WebFont.load({
            ...
            inactive: function() {
                // google font not loaded, we will use the default font
                loading.style.display = 'none';
                var banner = new Banner();
                banner.initialize('canvas-banner');
            }
